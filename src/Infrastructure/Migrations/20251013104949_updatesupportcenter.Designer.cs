...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20251013104949_updatesupportcenter")]
    partial class updatesupportcenter
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.Entities.Meal", b =>
                {
                    ...
                    b.Property<decimal?>("NewCalories")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("NewCarbs")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("NewFats")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("NewProtein")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("NewQuantityGrams")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Domain.Models.Entities.SupportMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Models.Entities.SupportTicket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Models.Entities.SupportMessage", b =>
                {
                    b.HasOne("Domain.Models.Entities.SupportTicket", "Ticket")
                        .WithMany("Messages")
